    ...
    return (
        <div>
            <section className={`bg-white z-50 flex items-center sticky top-0 bg-opacity-95`}>
                ...
                <h1 className='py-5 text-xl font-bold opacity-90 ml-5'>Code With Zosh</h1>

            </section>

            <section>
                <img
                    src="https://i.pinimg.com/736x/fb/19/41/fb1941be7e8d1499e85ed1e67a0b36fe.jpg"
                    alt="" className='w-[100] h-[15rem] object-cover' />
            </section>

            <section className='pl-6'>
                <div className="flex justify-between items-start mt-5 h-[5rem]">
                    <Avatar alt='code with zosh'
                        className='tranform -translate-y-24'
                        src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKXYfoyICE4HL696OKPg8qi8uK8qsC6akSaw&s'
                ...
                <div className='mt-2 space-y-3'>
                    <p>Hello ,I'm  code with  zos, you will  find full stack project tutorial  on our website</p>
